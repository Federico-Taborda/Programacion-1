...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |Ejercicio 3|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp")) #f)))
...
; powernat :: Natural Natural -> Number
; Dados dos numeros naturales (n, m) la funcion devuelve como resultado de elevar n a la m

(check-expect (powernat 2 2) 4)
(check-expect (powernat 4 2) 16)
(check-expect (powernat 3 2) 9)
(check-expect (powernat 1 0) 1)
(check-expect (powernat 4 1) 4)

(define (powernat n m)
  (cond[(zero? m) 1]
       [else (multiplicar n (powernat n (sub1 m)))]
       ))